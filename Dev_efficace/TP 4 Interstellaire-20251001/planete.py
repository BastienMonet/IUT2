...
class Planete:
    ...
    def dessine(self, s_persistante, s_temp):
        ...
        for satelite in self.satelites:
            satelite.dessine(s_persistante, s_temp)
    ...
    def add_satellite(self, taille, rayon_orbite, v_angulaire,
        ...
        new_planete = Planete(taille, rayon_orbite, self.calcule_pos(), v_angulaire, couleur, trace, phase)
        self.satelites.append(new_planete)
        return new_planete
